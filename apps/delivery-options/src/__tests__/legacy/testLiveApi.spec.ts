...
import {BPOST, CONFIG, getCarrierConfiguration, KEY_CONFIG, MYPARCEL, POSTNL, SENDMYPARCEL} from '@myparcel-do/shared';
...
describe('test settings on the live API', () => {
  ...
  `(
    ...
    async ({platform, carrier, allowExtraDelivery, cutoffTime, extraCutoffTime, dropOffDays}) => {
      ...
      const fakeResponse = fakeDeliveryOptionsResponse(getRequestParameters(getCarrierConfiguration(POSTNL, MYPARCEL)));
