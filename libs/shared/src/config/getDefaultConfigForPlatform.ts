...
import {type DeliveryOptionsConfig, type SupportedPlatformName} from '../types';
...
export const getDefaultConfigForPlatform = (platform: SupportedPlatformName): Required<DeliveryOptionsConfig> => {
  ...
  return assign(
    {
      ...
      [CUTOFF_TIME]: CUTOFF_TIME_DEFAULT,
      [CUTOFF_TIME_SAME_DAY]: CUTOFF_TIME_SAME_DAY_DEFAULT,
      [DELIVERY_DAYS_WINDOW]: DELIVERY_DAYS_WINDOW_DEFAULT,
      [DROP_OFF_DAYS]: [1, 2, 3, 4, 5],
      [DROP_OFF_DELAY]: DROP_OFF_DELAY_DEFAULT,
